...
interface MSMEHeaderProps {
  onMenuToggle?: () => void
}

export function MSMEHeader({ onMenuToggle }: MSMEHeaderProps) {
      ...
      <div className="flex items-center gap-2 ml-auto">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={() => router.push('/business-operations/msme/profile')}>
              <User className="mr-2 h-4 w-4" /> Profile
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => setShowNotifications(true)}>
              <Bell className="mr-2 h-4 w-4" /> Notifications
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => router.push('/business-operations/msme/settings')}>
