...
export default function MSMERequirementSuccessPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6 py-10">
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                <li className="flex items-start gap-2">
                  ...
                  Our recruitment experts review your requirements
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="h-4 w-4 text-green-500 mt-0.5 shrink-0" />
                  A quotation with service charges and placement fees will be shared
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="h-4 w-4 text-green-500 mt-0.5 shrink-0" />
                  Once approved, a recruitment agency and HR consultant are assigned
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="h-4 w-4 text-green-500 mt-0.5 shrink-0" />
      ...
      <div className="flex justify-center gap-3">
        <Button variant="outline" onClick={() => router.push('/business-operations/msme/requirements')}>
          Post Another Requirement
        </Button>
        <Button onClick={() => router.push('/business-operations/msme/dashboard')} className="gap-2">
