...
const stats = [
  { label: 'Open Requirements', value: '3', icon: FileText, color: 'text-blue-600', bg: 'bg-blue-100' },
  { label: 'Active Recruitments', value: '2', icon: Briefcase, color: 'text-teal-600', bg: 'bg-teal-100' },
  { label: 'Assigned Agency', value: '1', icon: Building2, color: 'text-purple-600', bg: 'bg-purple-100' },
  { label: 'Assigned HR Recruiter', value: '2', icon: Users, color: 'text-indigo-600', bg: 'bg-indigo-100' },
  { label: 'Pending Quotations', value: '1', icon: FileCheck, color: 'text-orange-600', bg: 'bg-orange-100' },
  { label: 'Invoices', value: '₹1,18,000', icon: IndianRupee, color: 'text-green-600', bg: 'bg-green-100' },
]
...
const notifications = [
  ...
  { id: 3, title: 'Agency Assigned', message: 'A recruitment agency has been assigned to your requirement.', time: '2 days ago', type: 'success' },
...
const recentActivity = [
  ...
  { action: 'HR Recruiter assigned', detail: 'Rajesh Kumar assigned to your account', time: '5 days ago' },
]
...
export default function MSMEDashboard() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">Welcome, {user?.companyName || user?.name || 'MSME Client'}!</h1>
        ...
        <CardContent>
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <Button
              ...
              onClick={() => router.push('/business-operations/msme/requirements')}
            >
            ...
            <Button
              variant="outline"
              className="h-20 flex-col gap-1"
              onClick={() => router.push('/business-operations/msme/verification')}
            >
            ...
            <Button
              variant="outline"
              className="h-20 flex-col gap-1"
              onClick={() => router.push('/business-operations/msme/quotation')}
            >
            ...
            <Button
              variant="outline"
              className="h-20 flex-col gap-1"
              onClick={() => router.push('/business-operations/msme/tracker')}
            >
