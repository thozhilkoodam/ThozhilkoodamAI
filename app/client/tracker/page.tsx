...
const stages = [
  ...
  { id: 'admin_review', label: 'Admin Review', icon: Clock, completed: true, date: '16 Jun 2024', notes: 'Admin reviewed and approved.' },
  ...
  { id: 'client_approved', label: 'Client Approved', icon: ThumbsUp, completed: true, date: '20 Jun 2024', notes: 'Client approved the quotation.' },
  { id: 'recruiter_assigned', label: 'Recruiter Assigned', icon: UserCheck, completed: true, date: '21 Jun 2024', notes: 'Rajesh Kumar assigned as recruiter.' },
  { id: 'candidate_search', label: 'Candidate Search', icon: Search, completed: false, date: '22 Jun 2024', notes: 'Searching for suitable candidates.' },
  { id: 'interview', label: 'Interview', icon: MessageCircle, completed: false, date: '', notes: '' },
  { id: 'offer', label: 'Offer', icon: Briefcase, completed: false, date: '', notes: '' },
  { id: 'joining', label: 'Joining', icon: UserPlus, completed: false, date: '', notes: '' },
